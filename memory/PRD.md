...
- Trang chi tiết truyện theo wireframe: 3 cột (Tác giả+Thể loại | Bìa 3D+Tên truyện+Đọc từ đầu | Bảng xếp hạng+Lượt xem+Nội dung), "Lộ trình chương mới" timeline đường đứt nét so le trái/phải có chấm sáng, mục Bình luận (đăng/thích bình luận demo, sắp theo lượt mới + pill chap)
