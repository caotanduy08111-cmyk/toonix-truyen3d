...
- LightningIntro (/src/components/LightningIntro.jsx): intro 2.6s khi mở trang chủ lần đầu mỗi session — logo TOONIX flicker điện + 4 tia sét CSS (.hero-bolt, đánh nhanh 0.8s rồi mất, so le 0.35s) đánh qua chữ + flash nền, chạm để bỏ qua, lưu sessionStorage; logo.png đã feather viền (không còn khung chữ nhật)
